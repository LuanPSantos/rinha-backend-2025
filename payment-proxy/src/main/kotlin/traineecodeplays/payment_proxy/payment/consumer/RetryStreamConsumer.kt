...
import traineecodeplays.payment_proxy.payment.producer.PaymentRequestProducer.Companion.RETRY
import traineecodeplays.payment_proxy.payment.usecase.ProcessPaymentUseCase
import java.util.UUID.*

@Service
class RetryStreamConsumer(
    ...
    fun start() {
        subscription = receiver.receiveAutoAck(
            ...
            StreamOffset.create(RETRY, ReadOffset.lastConsumed())
        ).flatMap { record ->
